...
urlpatterns = [
    ...
    url(r'^list-events/', views.ListOpusEvents.as_view(), name='list-events'),
    url(r'^invite-organization-user/(?P<organization_id>.+)/', views.InviteOrganizationUser.as_view(), name='invite-organization-user'),
    url(r'^check-event/(?P<user_id>.+)/', views.CheckOpusEvent.as_view(), name='check-event'),
    url(r'^seen-event/(?P<event_id>.+)/', views.SeenOpusEvent.as_view(), name='seen-event'),
    ...
    url(r'^disabled-organization/(?P<user_id>.+)/', views.DisabledOpus.as_view(), name='disabled-organization'),
